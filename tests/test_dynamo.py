...
class DynamoClientTests(asynctest.TestCase):
    ...
    def test_init(self):
        ...
        assert issubclass(DynamoClient, BaseStorage) is True
    ...
    async def test_scan(self):
        api_res = {'ScannedCount': 1,
                   ...
                   'Items': [
                       {'attemps': {'N': '1'},
                        'id': {'S':
                               'urn:newsml:localhost:2016-04-01T15:01:37.662911:e8146c8d-7f5b-4bc9-b21d-9650064c567c'},
    ...
    async def test_get_post(self):
        api_res = {'Count': 1, 'ScannedCount': 2, 'Items': [
                   {'post_id': {'S':
                    'urn:newsml:localhost:2016-04-06T14:36:37.255055:f2266f58-1e5c-4021-85af-e39087d94372'},
    ...
    async def test_save_control(self):
        ...
        await self.client.save_control(doc)
        db.put_item.assert_called_once_with(
            ExpressionAttributeValues={':value': {'S': 'control'}},
